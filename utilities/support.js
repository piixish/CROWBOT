...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        const embed = new MessageEmbed()
            .setColor(color)
            .setDescription(`Pour rejoindre notre support [cliquez ici](https://https://discord.gg/JdpkxdNd6H.gg/nANSkCyehT) \n**Dévelopeur :** <@!843204602686078976>`)
            .setFooter({ text: config.app.footer })

        message.reply({ content: 'Je vous ai envoyé mon serveur support par message privé' })
        message.react('✔️')
        message.member.send({ content: `https://discord.https://discord.gg/JdpkxdNd6H/nANSkCyehT`, embeds: [embed] }).catch(() => false);
    }
}